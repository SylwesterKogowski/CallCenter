...
const collectMessages = (errors: FormErrors, apiError?: string | null) => {
  ...
  if (errors.client?.general) {
    messages.push(errors.client.general);
  }
...
export const ErrorDisplay: React.FC<ErrorDisplayProps> = ({
  ...
  return (
    <div
      className="flex items-start gap-3 rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-800 dark:border-red-900 dark:bg-red-950/30 dark:text-red-200"
      role="alert"
      data-testid="ticket-add-error-display"
    >
